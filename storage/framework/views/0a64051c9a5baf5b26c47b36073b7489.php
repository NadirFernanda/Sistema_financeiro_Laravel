...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="file" class="form-control form-control-lg rounded-3 shadow-sm" wire:model="arquivo">
                    ...
                    <tr style="background:<?php if($loop->index % 2 == 0): ?>#f4f8ff;<?php else: ?> #fff;<?php endif; ?>">
                        ...
                        <td style="padding:14px 10px;vertical-align:middle;">
                            <div style="display:flex;flex-direction:column;align-items:flex-start;gap:8px;">
                                ...
                                <button class="btn btn-sm" style="background:#e74c3c;color:#fff;border:none;border-radius:8px;padding:7px 18px;font-weight:600;transition:background 0.2s;cursor:pointer;z-index:10;position:relative;" wire:click="delete('<?php echo e($fatura->numero_factura); ?>')">Excluir</button>
                            </div>
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\Administrator\Documents\INVOICE_LARAVEL\backend-laravel10\resources\views/livewire/faturas.blade.php ENDPATH**/ ?>